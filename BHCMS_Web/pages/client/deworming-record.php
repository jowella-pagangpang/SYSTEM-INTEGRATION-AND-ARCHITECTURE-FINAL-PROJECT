  ...
  ?>
    ...
    if ($_SESSION['type'] == "Barangay Health Worker") {
      ?>
                    ...
                    <div class="row">
                      <div class="col-11">
                        ...
                        <div class="col-1 text-right">
                            <a href="../deworming1/deworming.php" class="btn btn-dark btn-sm">
        ...
        <div class="card-block">
                        <div class="row">
                          ...
                          <div class="col-2"> 
                            <button type="button" class="btn btn-primary bg-gradient-primary btn-block btn-sm"
                              data-toggle="modal" data-target="#add-client1"><i class="nav-icon fas fa-user-plus"></i> Add new record
                            </button>
                        </div>
                        </div>
                      </div>
          ...
          <table id="example" class="table table-bordered table-hover text-center">
            ...
            <tr class="bg-light color-palette">
                <th colspan="5" class="text-left">DEWORMING SERVICES</th>
            </tr>
              <tr>
          ...
          <?php while ($data = mysqli_fetch_array($deworming1st)) { ?>
            ...
            <tr>
              ...
              <td>
                  <a href="deworming-update.php?id=<?php echo $data['deworming_id']; ?>">
        ...
        <?php include('deworming-addclient.php'); ?>
