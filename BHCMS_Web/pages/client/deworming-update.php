...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="font-weight-bold" style="font-family: Helvetica;">DEWORMING SERVICES</h4>
                            </div>
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
                                ...
                                <form method="post">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php
                                            $id = $_GET['id'];
                                            $edit = mysqli_query($con, "SELECT * FROM deworming INNER JOIN client ON deworming.patientid = client.id 
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                    $firstDose = $row['1stdose'];
                                                    $readonly = ($firstDose === '0000-00-00') ? '' : 'readonly';
                                                    ?>
                                                    <label>1st Dose:</label>
                                                    <input name="1stdose" class="form-control form-control-sm" type="date"
                                                        value="<?php echo $firstDose; ?>" <?php echo $readonly; ?>>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <?php
                                                    $secondDose = $row['2nddose'];
                                                    $readonly = ($secondDose === '0000-00-00') ? '' : 'readonly';
                                                    ?>
                                                    <label>2nd Dose:</label>
                                                    <input name="2nddose" class="form-control form-control-sm" type="date"
                                                        value="<?php echo $secondDose; ?>" <?php echo $readonly; ?>>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <a href="deworming-record.php?id=<?php echo $row['patientid']; ?>">
        ...
        if (isset($_POST['update'])) {
            ...
            mysqli_query($con, "UPDATE deworming SET patientid='$patientid', reg_date='$reg_date', 1stdose='$first', 2nddose='$second', remarks='$remarks' WHERE deworming_id = '$id'"); ?>

            <script type="text/javascript">
                window.location = "deworming-record.php?id=<?php echo $row['patientid']; ?>";
            </script>
