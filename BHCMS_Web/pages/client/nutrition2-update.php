...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="weight" class="form-control form-control-sm" type="number"
                                                        min="0" step="0.01" value="<?php echo $weight; ?>" <?php echo $readonly2; ?>>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="height" class="form-control form-control-sm" type="number"
                                                        min="0" value="<?php echo $height; ?>" <?php echo $readonly3; ?>>
                                                </div>
                                            </div>
        ...
        if (isset($_POST['update'])) {
            ...
            mysqli_query($con, "UPDATE nutrition2 SET patientid='$patientid', reg_date='$reg_date', 
            weight='$weight', height='$height' WHERE nutrition2_id = '$id'"); ?>
