...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
                                ...
                                <form method="post">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php
                                            $agep = $row['pneumonia_age'];
                                            $datep = $row['pneumonia_treatment_date'];
                                            $readonly1 = ($agep === '0') ? '' : 'readonly';
                                            $readonly2 = ($datep === '0000-00-00') ? '' : 'readonly';
                                            ?>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group ">
                                                            <label>Age:</label>
                                                            <input name="pneumonia_age" class="form-control form-control-sm"
                                                                type="number" min="0" 
                                                                value="<?php echo $agep; ?>" <?php echo $readonly1; ?>>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Date Given Treatment:</label>
                                                            <input name="pneumonia_treatment_date"
                                                                class="form-control form-control-sm" type="date" 
                                                                value="<?php echo $datep; ?>" <?php echo $readonly2; ?>>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        if (isset($_POST['update'])) {
            ...
            pneumonia_age='$pneumonia_age', pneumonia_treatment_date='$pneumonia_treatment_date' WHERE sick_children_id = '$id'"); ?>
