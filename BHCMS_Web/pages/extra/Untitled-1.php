            ...
            <div class="col-12">
              <div class="card">
                ...
                <form method="post">
                  <div class="card-body d-flex flex-column">
                    <div class="card-block">
                      ...
                      <?php
                      if ($service == "deworming1") {
                        $deworming1st = mysqli_query($con, "SELECT deworming1_id, DATE_FORMAT(reg_date,'%m-%d-%Y') AS regdate, 
                            ...
                            <tbody>
                              ...
                              while ($data = mysqli_fetch_array($deworming1st)) { ?>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <?php echo $data['1st_dose']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['2nd_dose']; ?>
                                    </td>
                                    <td>
                ...
                FROM $service WHERE reg_date between '$date' AND '$newDate'");
                      ...
                      if ($service == "deworming3") {
                        ?>
                          ...
                          <?php
                          $deworming3rd = mysqli_query($con, "SELECT deworming3_id, DATE_FORMAT(reg_date,'%m-%d-%Y') AS regdate, 
                              DATE_FORMAT(birth_date,'%m-%d-%Y') AS birthdate, 
                              CONCAT(fname, ' ', minitial, ' ', lname) AS fullname, sex, mother_name, 
                              purok, address, age, DATE_FORMAT(1stdose,'%m-%d-%Y') AS 1st_dose, 
                              DATE_FORMAT(2nddose,'%m-%d-%Y') AS 2nd_dose, remarks 
                                ...
                                <table id="example" class="table table-bordered table-hover table-sm text-center"
                                  ...
                                  <thead>
                                    <tr>
                                      ...
                                      <th rowspan="2">Complete <br>Address</th>
                                  ...
                                  <tbody>
                                    ...
                                    while ($data = mysqli_fetch_array($immunization)) { ?>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <?php echo $data['breastfeed']; ?>
                                          </td>
                                          <td>
                                            <?php echo $data['bcgdate']; ?>
                                          </td>
                                          <td>
                                            <?php echo $data['hepabdate']; ?>
                                          </td>
                                        </tr>
                                ...
                                <table id="example2" class="table table-bordered table-hover table-sm text-center" width="100%">
                                  ...
                                  <tbody>
                                    ...
                                    while ($data = mysqli_fetch_array($immunization)) { ?>
                                        ...
                                        <tr>
                                          <td>
                                            <?php echo $data['dpt_hib_hepb1']; ?>
                                          </td>
                                          <td>
                                            <?php echo $data['dpt_hib_hepb2']; ?>
                                          </td>
                                          <td>
                                            <?php echo $data['dpt_hib_hepb3']; ?>
                                          </td>
                                          <td>
                                            <?php echo $data['opv1']; ?>
                                          </td>
                  ...
                  remarks FROM $service WHERE reg_date between '$date' AND '$newDate'");
                                ...
                                while ($data = mysqli_fetch_array($nutrition1)) { ?>
                                    ...
                                    <tr>
                                      ...
                                      <?php echo $data['tetanus_status']; ?><br>
                                        <?php echo $data['datett']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['assess']; ?>
                                      </td>
                                    </tr>
                                    <?php
                                } ?>
                    ...
                    FROM $service WHERE reg_date between '$date' AND '$newDate'");
                            ...
                            <table id="example1" class="table table-bordered table-hover table-sm text-center" width="100%">
                              ...
                              while ($data = mysqli_fetch_array($nutrition1)) { ?>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <?php echo $data['mcv1st']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['mcv2nd']; ?>
                                      </td>
                                    </tr>
                                    <?php
                              } ?>
                          ...
                          <?php
                          $nutrition1 = mysqli_query($con, "SELECT nutrition1_id, DATE_FORMAT(ficdate,'%m-%d-%Y') AS fic, check1, 
                    DATE_FORMAT(breastfed1st,'%m-%d-%Y') AS breastfed1, check2, DATE_FORMAT(breastfed2nd,'%m-%d-%Y') AS breastfed2, 
                    check3, DATE_FORMAT(breastfed3rd,'%m-%d-%Y') AS breastfed3, check4, DATE_FORMAT(breastfed4th, '%m-%d-%Y') AS breastfed4,  
                    check5, DATE_FORMAT(breastfed5th,'%m-%d-%Y') AS breastfed5, check6, DATE_FORMAT(breastfed6th,'%m-%d-%Y') AS breastfed6, 
                    checkcf, DATE_FORMAT(complementary,'%m-%d-%Y') AS comple, remarks FROM $service WHERE reg_date between '$date' AND '$newDate'");
                          ?>
                            ...
                            <table id="example2" class="table table-bordered table-hover table-sm text-center" width="100%">
                              ...
                              while ($data = mysqli_fetch_array($nutrition1)) { ?>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                      <?php echo $data['check1']; ?><br>
                                        <?php echo $data['breastfed1']; ?>
                                      </td>
                                      <td>
                                      <?php echo $data['check2']; ?><br>
                                        <?php echo $data['breastfed2']; ?>
                                      </td>
                                      <td>
                                      <?php echo $data['check3']; ?><br>
                                        <?php echo $data['breastfed3']; ?>
                                      </td>
                                      <td>
                                      <?php echo $data['check4']; ?><br>
                                        <?php echo $data['breastfed4']; ?>
                                      </td>
                                      <td>
                                      <?php echo $data['check5']; ?><br>
                                        <?php echo $data['breastfed5']; ?>
                                      </td>
                                      <td>
                                      <?php echo $data['check6']; ?><br>
                                        <?php echo $data['breastfed6']; ?>
                                      </td>
                                      <td>
                                      <?php echo $data['checkcf']; ?><br>
                                        <?php echo $data['comple']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['remarks']; ?>
                                      </td>
                          ...
                          <div class="tab-pane fade py-3" id="page2">
                            <table id="example1" class="table table-bordered table-hover table-sm text-center" width="100%">
                              ...
                              while ($data = mysqli_fetch_array($nutrition2)) { ?>
                                    ...
                                    <tr>
                                      <td>
                                        <?php echo $data['vitamin']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['vitamindose1']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['vitamindose2']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['irondose1']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['irondose2']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['mnpdose1']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['mnpdose2']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['dewormings']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['remarks']; ?>
                                      </td>
                          ...
                          <table id="example" class="table table-bordered table-hover table-sm text-center" cellspacing="0"
                            ...
                            <tbody>
                              ...
                              while ($data = mysqli_fetch_array($sickchildren)) { ?>
                                  ...
                                  <tr>
                                    <td>
                                      <?php echo $data['sick_children_id']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['regdate']; ?>
                                    </td>
                ...
                pneumonia_age, DATE_FORMAT(pneumonia_treatment_date,'%m-%d-%Y') AS pneumoniadate, remarks FROM $service WHERE reg_date between '$date' AND '$newDate'");
                            ...
                            <tbody>
                              ...
                              while ($data = mysqli_fetch_array($sickchildren)) { ?>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <?php echo $data['vitamindate']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['diarrhea_age']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['orsdate']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['oralzincdate']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['pneumonia_age']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['pneumoniadate']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['remarks']; ?>
                                    </td>
                  ...
                  DATE_FORMAT(trimester1,'%m-%d-%Y') AS tri1, DATE_FORMAT(trimester2,'%m-%d-%Y') AS tri2, 
                  DATE_FORMAT(trimester3,'%m-%d-%Y') AS tri3 FROM $service WHERE reg_date between '$date' AND '$newDate'");
                      ?>
                            ...
                            <tbody>
                              ...
                              while ($data = mysqli_fetch_array($maternal)) { ?>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <?php echo $data['lmpdate']; ?> 
                                      <br>G<?php echo $data['g']; ?>
                                      P<?php echo $data['p']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['edcdate']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['tri1']; ?>
                                    </td>
                            ...
                            <tbody>
                              ...
                              while ($data = mysqli_fetch_array($maternal)) { ?>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <?php echo $data['iron1st']; ?> <br>
                                      <?php echo $data['1stdatenumber']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['iron2nd']; ?> <br>
                                      <?php echo $data['2nddatenumber']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['iron3rd']; ?> <br>
                                      <?php echo $data['3rddatenumber']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['iron4th']; ?> <br>
                                      <?php echo $data['4thdatenumber']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['iron5th']; ?> <br>
                                        <?php echo $data['5thdatenumber']; ?>
                                      </td>
                                      <td>
                                        <?php echo $data['iron6th']; ?> <br>
                                        <?php echo $data['6thdatenumber']; ?>
                                      </td>
                                      </tr>
                              ...
                              while ($data = mysqli_fetch_array($maternal)) { ?>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <?php echo $data['penicillin_date']; ?>
                                    </td>
                                    <td>
                                      <?php echo $data['terminated_date']; ?>
                                    </td>
                                    <td>
                    ...
                    FROM $service WHERE delivery_date between '$date' AND '$newDate'");
                        while ($data = mysqli_fetch_array($postpartum)) { ?>
                            ...
                            <tr>
                              ...
                              <td>
                                <?php echo $data['visit1week']; ?>
                              </td>
                              <td>
                                <?php echo $data['datebreastfeed']; ?> <br>
                                <?php echo $data['timebreastfeed']; ?>
                              </td>
                              <td>
                                <?php echo $data['iron1stdate']; ?> <br>
                                <?php echo $data['1stdate_tablets']; ?>
                              </td>
                              <td>
                                <?php echo $data['iron2nddate']; ?> <br>
                                <?php echo $data['2nddate_tablets']; ?>
                              </td>
                              <td>
                                <?php echo $data['iron3rddate']; ?> <br>
                                <?php echo $data['3rddate_tablets']; ?>
                              </td>
                              <td>
                                <?php echo $data['vitamindate']; ?>
                              </td>
