            ...
            <div class="card">
              ...
              <form method="post">
                <div class="card-body d-flex flex-column">
                  ...
                  FROM deworming WHERE service = 'Deworming 5-9 years old'");
                  ?>
                    ...
                    <tbody>
                      ...
                      while ($data = mysqli_fetch_array($deworming2nd)) { ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($data['1st_dose']>0) {echo $data['1st_dose'];}; ?>
                          </td>
                          <td>
                            <?php if($data['2nd_dose']>0) {echo $data['2nd_dose'];}; ?>
                          </td>
                          <td>
                            <?php echo $data['remarks']; ?>
                          </td>
                          <td>
                            <a href="edit-patient.php?did2=<?php echo $data['deworming_id']; ?>">
                              <button type="button" class="btn btn-primary btn-xs">
                                <i class="nav-icon fas fa-edit"></i></button>
                            </a>
                            <a href="deletepatient.php?did2=<?php echo $data['deworming_id']; ?>"
