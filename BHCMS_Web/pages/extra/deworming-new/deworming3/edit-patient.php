...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
                            ...
                            <form method="post">
                                <div class="card-body d-flex flex-column">
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-5">
                                                ...
                                                <h5 class="font-weight-bold">Edit patient record</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <?php
                                        $did3 = $_GET['did3'];
                                        $edit = mysqli_query($con, "SELECT * FROM deworming WHERE deworming_id = '$did3'");
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="remarks" class="form-control form-control-sm"
                                                    rows="1"><?php echo $row['remarks']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <a href="../deworming3/deworming10-19.php">
  ...
  age='$age', 1stdose='$first', 2nddose='$second', remarks='$remarks' WHERE deworming_id = '$did3'"); ?>
