                    ...
                    <div class="col-6">
                      <div class="form-group">
                          ...
                          <option selected disabled value="">Select Health Service</option>
                            ...
                            <option value="deworming">Deworming (1-4 years old)</option>
                            <option value="deworming">Deworming (5-9 years old)</option>
                            <option value="deworming">Deworming (10-19 years old)</option>
