      ...
      <section class="content text-sm" style="font-family: Helvetica;">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <br>
              <form method="post" action="reportmonthly.php">
                <div class="card-body d-flex flex-column">
                  <div class="card-block">
                    ...
                    <div class="col-6">
                      ...
                      <div class="col-2">
                        <button type="submit" class="btn btn-primary bg-gradient-primary btn-block btn-sm">
                          Generate
                        </button>
                      </div>
                    </div>
      ...
      <section class="content text-sm" style="font-family: Helvetica;">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <br>
              <form method="post" action="reportmonthly-nurse.php">
                <div class="card-body d-flex flex-column">
                  <div class="card-block">
                    <div class="row">
                    <div class="col-6">
