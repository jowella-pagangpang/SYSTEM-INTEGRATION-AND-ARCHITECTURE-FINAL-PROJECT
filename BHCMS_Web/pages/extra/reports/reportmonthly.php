                ...
                <ul class="nav nav-pills nav-sidebar flex-column text-sm" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="../main/monthly.php" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Monthly Report</p>
                                </a>
                            </li>
        ...
        <div class="content-wrapper">
          ...
          <div class="content-header">
            <div class="container-fluid">
              <div class="row">
                <div class="col-9">
                  <h4 class="font-weight-bold" style="font-family: Helvetica;">MONTHLY REPORT</h4>
                </div>
                <div class="col-2">
                </div>
                <div class="col-1">
                  <div class="form-group">
                    <a href="monthly.php" class="btn btn-secondary bg-gradient-secondary btn-block">Back</a>
                  </div>
                </div>
              </div><!-- /.row -->
            </div><!-- /.container-fluid -->
          ...
          <section class="content text-sm" style="font-family: Helvetica;">
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <form method="post">
                    ...
                    <?php  if ($service == "deworming") { ?>
                      <div class="col-2">
                        <div class="form-group">
                        <a href="dewormingmonthly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Monthly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="immunizationmonthly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Monthly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="nutrition1monthly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Monthly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="nutrition2monthly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Monthly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="sickchildrenmonthly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Monthly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="maternalmonthly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Monthly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="postpartummonthly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Monthly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                ...
                <h5 class="font-weight-bold text-center">TARGET CLIENT LIST FOR DEWORMING FOR 10-19 YEARS OLD
                  ...
                  DATE_FORMAT(hepab,'%m-%d-%Y') AS hepabdate FROM $service WHERE reg_date between '$date' AND '$newDate'");
                              ...
                              <div class="tab-pane fade py-3" id="page2">
                                ...
                                <td>
                                  <?php if($data['breastfeed'] != '00-00-0000') {echo $data['breastfeed'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['bcgdate'] != '00-00-0000') {echo $data['bcgdate'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['hepabdate'] != '00-00-0000') {echo $data['hepabdate'];}; ?>
                                </td>
                                        </tr>
                                ...
                                <table id="example2" class="table table-bordered table-hover table-sm text-center" width="100%">
                                  ...
                                  <tbody>
                                    ...
                                    while ($data = mysqli_fetch_array($immunization)) { ?>
                                        ...
                                        <tr>
                                <td>
                                  <?php if($data['dpt_hib_hepb1'] != '00-00-0000') {echo $data['dpt_hib_hepb1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['dpt_hib_hepb2'] != '00-00-0000') {echo $data['dpt_hib_hepb2'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['dpt_hib_hepb3'] != '00-00-0000') {echo $data['dpt_hib_hepb3'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['opv1'] != '00-00-0000') {echo $data['opv1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['opv2'] != '00-00-0000') {echo $data['opv2'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['opv3'] != '00-00-0000') {echo $data['opv3'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['pcv1'] != '00-00-0000') {echo $data['pcv1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['pcv2'] != '00-00-0000') {echo $data['pcv2'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['pcv3'] != '00-00-0000') {echo $data['pcv3'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['ipvdate'] != '00-00-0000') {echo $data['ipvdate'];}; ?>
                                </td>
                                        </tr>
                                ...
                                <table id="example3" class="table table-bordered table-hover table-sm text-center" width="100%">
                                  ...
                                  <tbody>
                                    ...
                                    while ($data = mysqli_fetch_array($immunization)) { ?>
                                        ...
                                        <tr>
                                <td>
                                  <?php if($data['mmr1'] != '00-00-0000') {echo $data['mmr1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['mmr2'] != '00-00-0000') {echo $data['mmr2'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['fic'] != '00-00-0000') {echo $data['fic'];}; ?>
                                </td>
                                <td>
                                  <?php echo nl2br($data['remarks']); ?>
                                </td>
                          ...
                          <div class="tab-pane fade py-3" id="page2">
                            <table id="example1" class="table table-bordered table-hover table-sm text-center" width="100%">
                              ...
                              while ($data = mysqli_fetch_array($nutrition1)) { ?>
                                ...
                                <td>
                                  <?php if($data['hepadate'] != '00-00-0000') {echo $data['hepadate'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['penta1'] != '00-00-0000') {echo $data['penta1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['penta2'] != '00-00-0000') {echo $data['penta2'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['penta3'] != '00-00-0000') {echo $data['penta3'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['opv1'] != '00-00-0000') {echo $data['opv1'];}; ?>
                                </td>
                                ...
                                <td>
                                  <?php if($data['ipv1'] != '00-00-0000') {echo $data['ipv1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['mcv1st'] != '00-00-0000') {echo $data['mcv1st'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['mcv2nd'] != '00-00-0000') {echo $data['mcv2nd'];}; ?>
                                </td>
                                    </tr>
                                    <?php
                              } ?>
                          ...
                          <div class="tab-pane fade py-3" id="page3">
                            <table id="example2" class="table table-bordered table-hover table-sm text-center" width="100%">
                              ...
                              while ($data = mysqli_fetch_array($nutrition1)) { ?>
                                ...
                                <td>
                                  <?php if($data['breastfed1'] != '00-00-0000') {echo $data['breastfed1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['breastfed2'] != '00-00-0000') {echo $data['breastfed2'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['breastfed3'] != '00-00-0000') {echo $data['breastfed3'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['breastfed4'] != '00-00-0000') {echo $data['breastfed4'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['breastfed5'] != '00-00-0000') {echo $data['breastfed5'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['breastfed6'] != '00-00-0000') {echo $data['breastfed6'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['comple'] != '00-00-0000') {echo $data['comple'];}; ?>
                                </td>
                                <td>
                                  <?php echo nl2br($data['remarks']); ?>
                                </td>
                ...
                weight, height, sex, 6to11mos, 12to59mos, mother_name, CONCAT(purok, ', ', address) AS caddress FROM $service WHERE reg_date between '$date' AND '$newDate'");
                        ?>
                          ...
                          <div class="tab-pane fade py-3" id="page2">
                            <table id="example1" class="table table-bordered table-hover table-sm text-center" width="100%">
                              ...
                              while ($data = mysqli_fetch_array($nutrition2)) { ?>
                                    ...
                                    <tr>
                                <td>
                                  <?php if($data['vitamin'] != '00-00-0000') {echo $data['vitamin'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['vitamindose1'] != '00-00-0000') {echo $data['vitamindose1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['vitamindose2'] != '00-00-0000') {echo $data['vitamindose2'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['irondose1'] != '00-00-0000') {echo $data['irondose1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['irondose2'] != '00-00-0000') {echo $data['irondose2'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['mnpdose1'] != '00-00-0000') {echo $data['mnpdose1'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['mnpdose2'] != '00-00-0000') {echo $data['mnpdose2'];}; ?>
                                </td>
                                <td>
                                  <?php if($data['dewormings'] != '00-00-0000') {echo $data['dewormings'];}; ?>
                                </td>
                                <td>
                                  <?php echo nl2br($data['remarks']); ?>
                                </td>
                        ...
                        <div class="tab-pane active py-3" id="page1">
                          <table id="example" class="table table-bordered table-hover table-sm text-center" cellspacing="0"
                            ...
                            <tbody>
                              ...
                              <td>
                                <?php if($data['tri1'] != '00-00-0000') {echo $data['tri1'];}; ?> <br>
                                <?php if($data['tri1a'] != '00-00-0000') {echo $data['tri1a'];}; ?>
                              </td>
                              <td>
                                <?php if($data['tri2'] != '00-00-0000') {echo $data['tri2'];}; ?> <br>
                                <?php if($data['tri2a'] != '00-00-0000') {echo $data['tri2a'];}; ?>
                              </td>
                              <td>
                                <?php if($data['tri3'] != '00-00-0000') {echo $data['tri3'];}; ?> <br>
                                <?php if($data['tri3a'] != '00-00-0000') {echo $data['tri3a'];}; ?>
                              </td>
                                  </tr>
