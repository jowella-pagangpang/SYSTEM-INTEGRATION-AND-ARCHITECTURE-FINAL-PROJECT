                ...
                <form method="post">
                  <div class="card-body d-flex flex-column">
                    ...
                    <?php  if ($service == "deworming") { ?>
                      <div class="col-2">
                        <div class="form-group">
                        <a href="dewormingweekly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Weekly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="immunizationweekly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Weekly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="nutrition1weekly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Weekly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="nutrition2weekly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Weekly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="sickchildrenweekly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Weekly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="maternalweekly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Weekly Report</a>
                      </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="col-2">
                        <div class="form-group">
                        <a href="postpartumweekly.php?date=<?php echo $date; ?>" class="btn btn-success bg-gradient-success btn-block">
                        <i class="nav-icon fas fa-file-excel"></i> Weekly Report</a>
                      </div>
                      </div>
                      <?php } ?>
