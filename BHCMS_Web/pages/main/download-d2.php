...
$objPHPExcel = $objReader->load("Classes/download-d2.xlsx");
...
$deworming2nd = mysqli_query($con, "SELECT id, deworming_id, patientid, DATE_FORMAT(reg_date,'%m-%d-%Y') AS regdate, 
    ...
    AND TIMESTAMPDIFF(YEAR, birth_date, CURDATE()) BETWEEN 5 AND 9");
...
header('Content-Disposition: attachment;filename="TCL-Deworming-5-9.xlsx"');
