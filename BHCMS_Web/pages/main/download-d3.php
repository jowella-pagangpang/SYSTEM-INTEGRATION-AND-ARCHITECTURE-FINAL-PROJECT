...
$objPHPExcel = $objReader->load("Classes/download-d3.xlsx");
...
$deworming3rd = mysqli_query($con, "SELECT id, deworming_id, patientid, DATE_FORMAT(reg_date,'%m-%d-%Y') AS regdate, 
                    ...
                    AND TIMESTAMPDIFF(YEAR, birth_date, CURDATE()) BETWEEN 10 AND 19");
...
header('Content-Disposition: attachment;filename="TCL-Deworming-10-19.xlsx"');
