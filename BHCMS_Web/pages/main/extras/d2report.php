...
$objPHPExcel = $objReader->load("Classes/mytemplates-deworming2-report.xlsx");
...
FROM deworming2 WHERE 1stdose IS NULL OR 2nddose IS NULL");
...
header('Content-Disposition: attachment;filename="Deworming_5-9_Patient_Report.xlsx"');
