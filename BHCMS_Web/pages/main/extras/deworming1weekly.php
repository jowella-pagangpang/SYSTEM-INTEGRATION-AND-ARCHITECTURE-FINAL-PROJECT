...
$objPHPExcel = $objReader->load("Classes/mytemplates-deworming1.xlsx");
...
FROM deworming1 WHERE reg_date between '$datenow' AND '$newDate'");
...
header('Content-Disposition: attachment;filename="Deworming_1-4_Weekly_Report.xlsx"');
