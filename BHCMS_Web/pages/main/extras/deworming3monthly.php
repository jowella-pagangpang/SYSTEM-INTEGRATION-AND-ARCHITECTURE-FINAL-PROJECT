...
$objPHPExcel = $objReader->load("Classes/mytemplates-deworming3.xlsx");
...
FROM deworming3 WHERE reg_date between '$datenow' AND '$newDate'");
...
header('Content-Disposition: attachment;filename="Deworming_10-19_Monthly_Report.xlsx"');
