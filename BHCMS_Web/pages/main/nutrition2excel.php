...
DATE_FORMAT(deworming,'%m-%d-%Y') AS dewormings, remarks, remarks1 FROM nutrition2 INNER JOIN client 
ON nutrition2.patientid = client.id WHERE reg_date between '$startdate' AND '$enddate'");
...
header('Content-Disposition: attachment;filename="TCL-Nutrition-Report.xlsx"');
