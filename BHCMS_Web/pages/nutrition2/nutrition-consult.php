                ...
                <div class="col-3"></div>
                    <div class="col-6">
                        <div class="card">
                            ...
                            <form method="post" action="n-add-insert.php">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="row">
                                            ...
                                            <?php
                                            $nid = $_GET['nid'];
                                            $edit = mysqli_query($con, "SELECT * FROM nutrition2 INNER JOIN client 
                                            ON nutrition2.patientid = client.id WHERE patientid = $nid;");
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="patientid" class="form-control form-control-sm"
                                                        type="number" value="<?php echo $nid; ?>" readonly>
                                                </div>
                                            </div>
