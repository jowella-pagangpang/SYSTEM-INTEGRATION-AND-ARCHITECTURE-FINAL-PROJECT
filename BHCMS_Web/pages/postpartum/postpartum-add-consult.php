                ...
                <div class="col-3"></div>
                    <div class="col-6">
                        <div class="card">
                            ...
                            <form method="post" action="p-add-insert.php">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="row">
                                            ...
                                            <?php
                                            $pid = $_GET['pid'];
                                            $edit = mysqli_query($con, "SELECT * FROM postpartum INNER JOIN client 
                                            ON postpartum.patientid = client.id WHERE patientid = $pid;");
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="patientid" class="form-control form-control-sm"
                                                        type="number" value="<?php echo $pid; ?>" readonly>
                                                </div>
                                            </div>
