                ...
                <div class="col-3"></div>
                    <div class="col-6">
                        <div class="card">
                            ...
                            <form method="post" action="add-insert-consultation.php">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="row">
                                            ...
                                            <?php
                                            $sid = $_GET['sid'];
                                            $edit = mysqli_query($con, "SELECT * FROM sickchildren INNER JOIN client 
                                            ON sickchildren.patientid = client.id WHERE patientid = $sid;");
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="patientid" class="form-control form-control-sm"
                                                        type="number" value="<?php echo $sid; ?>" readonly>
                                                </div>
                                            </div>
